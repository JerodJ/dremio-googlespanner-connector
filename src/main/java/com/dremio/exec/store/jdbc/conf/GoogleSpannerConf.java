...
@SourceType(value = "GoogleSpannerARP", label = "GoogleSpanner",uiConfig = "googlespanner-layout.json")
public class GoogleSpannerConf extends AbstractArpConf<GoogleSpannerConf> {
  private static final String ARP_FILENAME = "arp/implementation/googlespanner-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googlespanner.GoogleSpannerDriver";
